...
const sampleProducts = [
    ...
    },
    {
        ...
        variants: [
            {
                images: [ { url: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=1000&q=80" } ],
                stock: 40,
                attributes: { "Color": "Pitch Black", "Size": "M" },
                price: { amount: 1899, currency: "INR" }
            },
            {
                images: [ { url: "https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?auto=format&fit=crop&w=1000&q=80" } ],
                stock: 35,
    ...
    },
    {
        ...
        variants: [
            {
                images: [ { url: "https://images.unsplash.com/photo-1638247025967-b4e38f787b76?auto=format&fit=crop&w=1000&q=80" } ],
                stock: 10,
                attributes: { "Color": "Polished Black", "Size": "42" },
                price: { amount: 9999, currency: "INR" }
            },
            {
                images: [ { url: "https://images.unsplash.com/photo-1549298916-b41d501d3772?auto=format&fit=crop&w=1000&q=80" } ],
                stock: 8,
    ...
    },
    {
        ...
        variants: [
            {
                images: [ { url: "https://images.unsplash.com/photo-1544441893-675973e31985?auto=format&fit=crop&w=1000&q=80" } ],
                stock: 16,
                attributes: { "Color": "Tabac Brown", "Size": "L" },
                price: { amount: 4999, currency: "INR" }
            },
            {
                images: [ { url: "https://images.unsplash.com/photo-1548883354-7622d03aca27?auto=format&fit=crop&w=1000&q=80" } ],
                stock: 12,
    ...
    },
    {
        ...
        variants: [
            {
                images: [ { url: "https://images.unsplash.com/photo-1539533018447-63fcce2678e3?auto=format&fit=crop&w=1000&q=80" } ],
                stock: 6,
                attributes: { "Color": "Camel", "Size": "L" },
                price: { amount: 14999, currency: "INR" }
            },
            {
                images: [ { url: "https://images.unsplash.com/photo-1487222477894-8943e31ef7b2?auto=format&fit=crop&w=1000&q=80" } ],
                stock: 5,
    ...
    },
    {
        ...
        variants: [
            {
                images: [ { url: "https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?auto=format&fit=crop&w=1000&q=80" } ],
                stock: 18,
                attributes: { "Color": "Cream White", "Size": "M" },
                price: { amount: 3799, currency: "INR" }
            },
            {
                images: [ { url: "https://images.unsplash.com/photo-1576566588028-4147f3842f27?auto=format&fit=crop&w=1000&q=80" } ],
                stock: 15,
    ...
    },
    {
        ...
        variants: [
            {
                images: [ { url: "https://images.unsplash.com/photo-1607345366928-199ea26cfe3e?auto=format&fit=crop&w=1000&q=80" } ],
                stock: 22,
                attributes: { "Color": "Earth Brown", "Size": "L" },
                price: { amount: 2499, currency: "INR" }
            },
            {
                images: [ { url: "https://images.unsplash.com/photo-1516257984-b1b4d707412e?auto=format&fit=crop&w=1000&q=80" } ],
                stock: 19,
    ...
    },
    {
        ...
        variants: [
            {
                images: [ { url: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=1000&q=80" } ],
                stock: 15,
    ...
    },
    {
        ...
        variants: [
            {
                images: [ { url: "https://images.unsplash.com/photo-1509631179647-0177331693ae?auto=format&fit=crop&w=1000&q=80" } ],
                stock: 20,
    ...
    },
    {
        ...
        variants: [
            {
                images: [ { url: "https://images.unsplash.com/photo-1552902865-b72c031ac5ea?auto=format&fit=crop&w=1000&q=80" } ],
                stock: 25,
    ...
    {
        title: "Minimalist Suede Minimalist Loafers",
        ...
        variants: [
            {
                images: [ { url: "https://images.unsplash.com/photo-1533867617858-e7b97e060509?auto=format&fit=crop&w=1000&q=80" } ],
                stock: 12,
    ...
    },
    {
        ...
        variants: [
            ...
            {
                images: [ { url: "https://images.unsplash.com/photo-1594938298603-c8148c4dae35?auto=format&fit=crop&w=1000&q=80" } ],
                stock: 8,
    ...
    {
        title: "Heavyweight Waffle Knit Henleys",
...
async function seedCatalog() {
    try {
        ...
        console.log("Connected to MongoDB for 20-product expanded seeding...");
        ...
        console.log(`🎉 SUCCESSFULLY SEEDED ALL ${insertedProducts.length} PRODUCTS WITH 3-5 HD PHOTOS & FULL VARIANTS!`);
        process.exit(0);
    } catch (err) {
