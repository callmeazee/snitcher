...
const Register = () => {
    ...
    const getErrorMessage = (code) => {
        ...
        if (code === "invalid_client") {
            return "Google Sign-In Error (invalid_client): The GOOGLE_CLIENT_ID or GOOGLE_CLIENT_SECRET in Backend/.env is invalid or not registered in Google Cloud Console.";
        }
        return `Google authentication failed: ${code}`;
    };
            ...
            >
                ...
                >
                    <div className="w-full max-w-sm">
                        ...
                        {authError && (
                            <div className="mb-8 p-4 bg-amber-50 border border-amber-300 text-amber-900 text-xs leading-relaxed font-sans">
                                <strong>Notice:</strong> {getErrorMessage(authError)}
                            </div>
                        )}
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-9">
                            ...
                            {/* Google SSO */}
                            <ContinueWithGoogle isSeller={formData.isSeller} />
